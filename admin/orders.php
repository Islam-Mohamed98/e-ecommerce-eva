<?php
    ...
    */
    ...
    if (isset($_SESSION['Username'])) {
        ...
        <div class="dashboard-main" data-class = "orders" style="margin-left:15%;padding:50px 16px;">
        <?php
/////////////////////////////////////==[Manage]==///////////////////////////////////////
                ...
                <div class="container">
                    ...
                    foreach($items as $item) {
                        echo'<tr>';
                            ...
                            echo'<td>
                                    <a href="items.php?do=Edit&itemid=' .$item['P_ID']. '"class="btn btn-success"><i class="fa fa-edit"></i>Edit</a>
                                    <a href="items.php?do=Delete&itemid='.$item['P_ID'].'" class="btn btn-danger check"><i class="fas fa-times"></i>Delete</a>';
                                    if ($item['Approve'] == 0){
                                      echo '<a href="items.php?do=Approve&itemid='.$item['P_ID'].'" class="btn btn-info activate"><i class="fas fa-check"></i>Approve</a>';
                                    }
                            echo '</td>';
                        echo'<tr>';
                    }
